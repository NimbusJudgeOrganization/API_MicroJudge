...
cwd = os.getcwd()
JUDGE_DIR = f"/etc/JUDGE_MicroJudge/Judge"
...
def handler(event, context):
    ...
    try:
        ...
        return {'body':"Bad request, file or question_name not found in body data.",
                        'status_code':400,
    ...
    if request.method == 'POST':
        try:
            ...
            return {'body':f'ok', 'status_code': 200, 'headers':{'Content-Type': 'text/plain'}}
        except:
